...
## 💡 깨달은 점
- 이전 프로젝트에서는 Controller, Repository 등으로 폴더를 묶는 **계층형 구조**였다면, 이번 프로젝트에서는 도메인별로 폴더를 묶는 **도메인형 구조**를 활용해보았다. Controller에서 매핑할때 기준이 모호해지는 경우도 생기지만 기준을 잘 정해둔다면 계층형보다 깔끔해 보인다.
...
- **AWS**랑 인텔리제이를 연결해 DB를 팀원들끼리 공유하며 사용해보니 확실히 편리하다는 것을 느꼈다.
